  ...
  if (!group.data) {
    return (
      <div className="mx-auto max-w-lg px-4 py-12 text-center">
        ...
        <a href="/join" className="mt-4 inline-block text-sm text-[var(--accent-red)]">
  ...
  if (!group.data.isAdmin) {
    return (
      <div className="mx-auto max-w-lg px-4 py-12 text-center">
        ...
        <a href="/dashboard" className="mt-4 inline-block text-sm text-[var(--text-muted)]">
          Back to dashboard →
        </a>
      </div>
    );
    ...
    <div className="mx-auto max-w-3xl space-y-8 px-4 py-8">
      ...
      <section className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-6">
        ...
        <p className="mt-4 text-xs text-[var(--text-muted)]">
          Hover cells for details. Toggle edit mode to set group-wide day labels.
        </p>
      </section>
    </div>
  );
